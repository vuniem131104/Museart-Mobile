      ...
      {isLoading ? (
        ...
        <ScrollView style={styles.body}>
          <Picture
            ...
            imagePath={`https://www.artic.edu/iiif/2/${artwork?.image_id}/full/843,/0/default.jpg`}
            date={artwork.timestamp}
            id={artwork.id}
            type="artwork"
          />
          <AboutTitle
            title={artwork?.title}
            tagRoute={artwork.artwork_type_title}
            tagDetail={artwork.department_title}
            isPrice={false}
          />
          ...
          <View>
            ...
            <FrameButton
              field="Artist Display"
              value={artwork?.artist_display}
            />
            <FrameButton
            ...
            <FrameButton
              ...
              value={artwork.classification_titles.map((item, i, arr) => {
            ...
            <View>
              ...
              <HTMLRender
                source={{
                  html:
                    artwork.description ||
                    "<p>This artwork currently has no description available.</p>",
                }}
                baseStyle={{
                  color: colors.onSurface,
            ...
            <View style={{ paddingTop: 10 }}>
              ...
              >
                {artwork.provenance_text ||
                  "No provenance information available for this artwork."}
              </Text>
            </View>
            ...
            <View style={{ paddingTop: 10 }}>
              ...
              >
                {artwork.publication_history_text ||
                  "No publication history available for this piece."}
              </Text>
            </View>
          </View>
