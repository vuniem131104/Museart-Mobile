...
const SettingsMenu = ({ closeMenu }) => {
  ...
  useEffect(() => {
    ...
    const fetchEmailIfNeeded = async () => {
      if (!userInfo || profileFetched.current) return;
    ...
    <>
      ...
      >
        ...
        <MenuItem
          ...
          imageSource={
            isDarkMode
              ? require("../../assets/Frame15.png")
              : require("../../assets/frame-141.png")
          }
          text="Feedback"
          func={handleFeedback}
        />
        ...
        <MenuItem
          ...
          imageSource={
            isDarkMode
              ? require("../../assets/Frame14.png")
              : require("../../assets/frame-14.png")
          }
          text="Cart"
          ...
          >
            <View style={styles.profileInfo}>
              <FontAwesome5
                ...
                color={colors.primary}
              />
              <Text style={[styles.profileText, { color: colors.onSurface }]}>
                {userEmail}
              </Text>
            </View>
