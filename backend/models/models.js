...
const ArtworkReaction = sequelize.define('ArtworkReaction', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true,
...
const ExhibitionReaction = sequelize.define('ExhibitionReaction', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true,
...
const ExhibitionComment = sequelize.define('ExhibitionComment', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true,
...
const ExhibitionArtwork = sequelize.define('ExhibitionArtwork', {
  exhibition_id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    allowNull: false
...
const ExhibitionTag = sequelize.define('ExhibitionTag', {
  exhibition_id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    allowNull: false
